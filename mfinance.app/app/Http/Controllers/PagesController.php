...
class PagesController extends Controller
{
    public function index()
    {
        ...
        $investments = Investment::me()->latest()->take(5)->get();
        $uaccounts = MAccount::me()->latest()->take(5)->get();
        return view('pages.dashboard', compact('page_title','investments','uaccounts'));
    }
