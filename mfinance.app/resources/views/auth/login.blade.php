...
<head><base href="../../../../">
    <meta charset="utf-8"/>
    <title>MFinance | Login</title>
    <meta name="description" content="Login into MFinance"/>
                    ...
                    <form class="form" id="kt_login_singin_form" action="{{route('login')}}" method="post">
                        ...
                        <div class="pb-5 pb-lg-15">
                            ...
                            <div class="text-muted font-weight-bold font-size-h4">
                                New one to MFinance family?
                                <a href="{{route('register.show')}}" class="text-primary font-weight-bolder">Register</a>
                            </div>
                        </div>
                        <!--begin::Title-->
                        @if($errors->has('result'))
                            <div class="alert alert-danger">
                                Sorry, Your credentials wrong!
                            </div>
                        @endif
...
</svg><!--end::Svg Icon--></span>                     Login with Google
                            </a>
                        </div>
                        <!--end::اکشن-->
                    </form>
