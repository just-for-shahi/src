...
<div id="kt_quick_user" class="offcanvas offcanvas-{{ $direction }} p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="navi navi-spacer-x-0 p-0">
		    {{-- Item --}}
		    <a href="{{route('account.show')}}" class="navi-item">
		        <div class="navi-link">
		    ...
		    {{-- Item --}}
		    <a href="{{route('investments.index')}}"  class="navi-item">
		        <div class="navi-link">
					<div class="symbol symbol-40 bg-light mr-3">
						<div class="symbol-label">
		...
		<div>
	        ...
	        <div class="d-flex align-items-center bg-light-warning rounded p-5 gutter-b">
	            ...
	            <div class="d-flex flex-column flex-grow-1 mr-2">
	                <a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">The UAccounts growth</a>
	        ...
	        <div class="d-flex align-items-center bg-light-success rounded p-5 gutter-b">
	            ...
	            <div class="d-flex flex-column flex-grow-1 mr-2">
	                <a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">The Milad AlgoTrading</a>
	                <span class="text-muted font-size-sm">Due in 2 Days</span>
	            </div>
	        ...
	        <div class="d-flex align-items-center bg-light-danger rounded p-5 gutter-b">
	            ...
	            <div class="d-flex flex-column flex-grow-1 mr-2">
	                <a href="#" class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">The Sfag AlgoTrading</a>
	                <span class="text-muted font-size-sm">Due in 2 Days</span>
	            </div>
	        ...
	        <div class="d-flex align-items-center bg-light-info rounded p-5">
	            ...
	            <div class="d-flex flex-column flex-grow-1 mr-2">
	                <a href="#" class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">The Nazanin AlgoTrading</a>
	                <span class="text-muted font-size-sm">Due in 2 Days</span>
	            </div>
