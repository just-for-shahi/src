            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="widget text_widget">
                        ...
                        <p>
                            <a href="tel:+97145182639" class="tel">+971-4518-2639</a>
                            <a href="mailto:support@mfinance.app" class="mail">Support@mfinance.app</a>
                            <span class="address">48 Burj Gate, Level 20, Dubai Mall Metro Station, Downtown Dubai, United Arab Emirates</span>
                        </p>
                    </div>
                </div><!-- ends: .col-lg-3 -->
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex justify-content-lg-center">
                    <div class="widget widget--links">
                        ...
                        <ul class="links">
                            ...
                            <li><a href="{{route('pages.contact')}}">Contacts Us</a></li>
