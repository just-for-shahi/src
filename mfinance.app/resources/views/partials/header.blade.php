...
$cfolder = $cpage = $enUrl = $arUrl = $peUrl = $tuUrl = "";

if(count($luri) === 2):
    $enUrl = SITE_URL.$cfolder.'/';
    $arUrl = SITE_URL.$cfolder.'/pages/ar/';
    $peUrl = SITE_URL.$cfolder.'/pages/pe/';
    $tuUrl = SITE_URL.$cfolder.'/pages/tu/';
elseif(count($luri) === 3):
    $cfolder = $luri[1];
    $cpage = $luri[2];
    $enUrl = SITE_URL.'/'.$cfolder.'/'.$cpage;
                        ...
                        <div class="top_bar--lang align-self-center order-2">
                            <div class="dropdown">
                                <div class="dropdown-toggle d-flex align-items-center" id="dropdownMenuButton1" role="menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <img class="lang_flag" src="{{asset('front/img/united-states.png')}}" alt="English">
                    ...
                    <div class="menu_area menu8">
                        <div class="container">
                            <nav class="navbar navbar-expand-lg navbar-light px-0 ">
                                <a class="navbar-brand order-sm-1 order-1" href="#"><img src="{{asset('front/img/logo.png')}}" alt="" /></a>
                                ...
                                <div class="collapse navbar-collapse order-md-1 justify-content-end" id="navbarSupportedContent22">
                                    <div class="m-right-15">
                                        <ul class="navbar-nav ">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="#maccounts">MAccounts</a></li>
                ...
                <div class="collapse navbar-collapse  justify-content-end" id="navbarSupportedContent22">
                    <div class="m-right-15">
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{route('index')}}#investment">Investment</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{route('index')}}#signals">Signals</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{route('index')}}#account-management">MAccounts</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{route('pages.about')}}">About</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{route('pages.contact')}}">Contact</a></li>
                        </ul>
                        <!-- end: .navbar-nav -->
