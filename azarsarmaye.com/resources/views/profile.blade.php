                            ...
                            <form role="form" method="post" action="{{route('profile.update')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" name="identity_no" class="form-control" id="identity_no" value="{{$user->identity_no}}">
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="row form-group">
                                    <div class="col-sm-3">
                                        <label for="identity_card_front" class="form-control-label">کارت ملی (تصویر رو)</label>
                                        <input type="file" name="identity_card_front" class="form-control" id="identity_card_front">
                                    </div>
                                    <div class="col-sm-3">
                                        <label for="identity_card_back" class="form-control-label">کارت ملی (تصویر پشت)</label>
                                        <input type="file" name="identity_card_back" class="form-control" id="identity_card_back">
                                    </div>
{{--                                    <div class="col-sm-3">--}}
