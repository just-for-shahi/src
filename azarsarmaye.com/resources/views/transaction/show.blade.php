                    ...
                    <br>
                        ...
                        <div class="box-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <label for="to" class="form-control-label">به حساب</label>
                                    <input type="text" class="form-control" id="to" disabled="disabled" value="{{\App\Helpers\AccountHelper::summary($transaction->to)}}">
                                </div>
                                <div class="col-sm-4">
                                    <label for="amount" class="form-control-label">مبلغ <small>ریال</small></label>
                                    <input type="text" class="form-control" id="amount" disabled="disabled" value="{{number_format($transaction->amount)}} تتر">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <br/>
                                    {!! \App\Helpers\PaymentHelper::transactionStatus($transaction->status) !!}
                                </div>
                            </div>
                            @if($transaction->status == 0)
                                <div class="form-group row m-t-md">
                                    <div class="col-sm-12">
                                        <a href="{{route('payment.pay', ['uuid' => $transaction->uuid])}}" class="btn btn-success btn-sm text-sm">پرداخت</a>
                                    </div>
                                </div>
                            @endif
                        </div>
