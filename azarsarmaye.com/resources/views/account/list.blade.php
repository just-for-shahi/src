                            ...
                            <div class="row-col h-v">
                                <div class="row-cell v-m">
                                    <div class="modal-dialog modal-md">
                                        <form action="{{route('admin.accounts.store')}}" method="post" class="modal-content">
                                            @csrf
                                ...
                                <tr style="background: rgba({{\App\Helpers\AccountHelper::hex2RGB(str_replace('#','', \App\Helpers\AccountHelper::color($item->color)), true)}},0.1);">
                                    ...
                                    <td>
                                        @if(auth()->user()->role === 6 && $item->status != 0)
                                            <a href="{{route('maccounts.accept', ['account' => $item->id])}}"
                                        ...
                                        <div id="charge-{{$item->uuid}}" class="modal" data-backdrop="true">
                                            <div class="row-col h-v">
                                                <div class="row-cell v-m">
                                                    <div class="modal-dialog modal-md">
                                                        <form method="post"
                                                              action="{{route('accounts.charge', ['uuid' => $item->uuid])}}"
                                                              class="modal-content">
                                                            @csrf
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body text-center p-lg">
                                                                <div class="row">
                                                                    @if(count($wallets) === 0)
                                                                        <div class="alert alert-danger">مشتری گرامی برای
                                                                            افزایش موجودی باید کیف پول ثبت شده داشته
                                                                            باشید.
                                                                        </div>
                                                                    @else
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit"
                                                                        class="btn btn-primary pull-right p-x-md">پرداخت
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    ...
                                                    <div class="modal-dialog modal-md">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-lg">
                                                                ...
                                                                @else
                                                                    <p>برای تسویه حساب باید موجودی حساب شما صفر باشد.
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                @if($item->balance == 0)
                                                                    <form
                                                                        action="{{route('accounts.destroy', ['uuid' => $item->uuid])}}"
                                                                        method="post">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button type="submit"
