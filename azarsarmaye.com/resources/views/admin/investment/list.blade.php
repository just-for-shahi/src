...
@section('pageTitle', 'لیست سرمایه‌گذاری ها')
@section('content')
    <div class="padding">
        <div class="row">
            <div class="col-sm-12">
                <div class="box">
                    <div class="box-header">
                        <div class="pull-left">
                            <h2>لیست سرمایه‌گذاری ها</h2>
                            <small>
                                در لیست زیر میتوانید تمامی سرمایه‌گذاری ها را مشاهده کنید
                            </small>
                        </div>
...
{{--                                        <form action="{{route('admin.investments.store')}}" method="post" class="modal-content">--}}
{{--                                            @csrf--}}
...
{{--                                                            <option disabled selected>ابتدا</option>--}}
{{--                                                        </select>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="col-sm-6 form-group">--}}
