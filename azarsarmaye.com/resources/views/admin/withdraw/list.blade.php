...
@section('pageTitle', 'لیست برداشت‌ها')
@section('content')
    <div class="padding">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="pull-left">
                            ...
                            <small>
                                در لیست زیر میتوانید تمامی برداشت‌ها را مشاهده کنید
                            </small>
                        </div>
{{--                        <a data-toggle="modal" data-target="#new"--}}
{{--                           class="btn btn-sm text-sm text-sm-center btn-primary text-white pull-right">برداشت جدید</a>--}}
                        <div id="new" class="modal" data-backdrop="true">
                            <div class="row-col h-v">
                                <div class="row-cell v-m">
                                    <div class="modal-dialog modal-md">
                                        <form action="{{route('admin.withdraws.store')}}" method="post"
                                              class="modal-content">
                                            @csrf
                                            ...
                                            <div class="modal-body text-center p-lg">
                                                <div class="row">
                                                    <div class="col-sm-6 form-group">
                                                        <label class="control-label text-right pull-left" for="account">برداشت
                                                            از</label>
                                                    ...
                                                    <div class="col-sm-6 form-group">
                                                        <label class="control-label text-right pull-left"
                                                               for="bankAccount">واریز به</label>
                                                        <select id="bankAccount" name="bank-account"
                                                                class="form-control">
                                                    ...
                                                    <div class="col-sm-12 form-group">
                                                        <label class="control-label text-right pull-left" for="amount">مبلغ
                                                            برداشت</label>
                                                        <input class="form-control" id="amount" name="amount"
                                                               type="number"
                                                               placeholder="لطفا مبلغ مدنظرتان را وارد کنید">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary pull-right p-x-md">ثبت
                                                    برداشت
                                                </button>
                                            </div>
                                        </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(auth()->user()->role === 6 && $item->status === 0)
                                            <a data-toggle="modal" data-target="#withdraw-{{$item->id}}"
                                               class="btn btn-success btn-sm text-sm text-white">پرداخت</a>
                                            <div id="withdraw-{{$item->id}}" class="modal" data-backdrop="true">
                                                <div class="row-col h-v">
                                                    <div class="row-cell v-m">
                                                        <div class="modal-dialog modal-sm">
                                                            <form method="post" class="pull-right"
                                                                  action="{{route('admin.mwithdraws.accept',  $item->uuid)}}">
                                                                @csrf
                                                                    ...
                                                                    <div class="modal-body text-center p-lg">
                                                                        <div class="form-group">
                                                                            <label class="form-control-label"
                                                                                   for="inquiry">شماره
                                                                                پیگیری</label>
                                                                            <input class="form-control" id="inquiry"
                                                                                   name="inquiry">
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button"
                                                                                class="btn dark-white p-x-md pull-left"
                                                                                data-dismiss="modal">انصراف
                                                                        </button>
                                                                        <button type="submit"
                                                                                class="btn success p-x-md">دستور
                                                                            پرداخت
                                                                        </button>
                                                                    </div>
                                                                </div>
                                        ...
                                        @if($item->status == 0)
                                            <a data-toggle="modal" data-target="#delete-{{$item->id}}"
                                               class="btn btn-danger btn-sm text-sm text-white">انصراف</a>
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form method="post" class="pull-right"
                                                                          action="{{route('admin.withdraws.destroy',  $item->uuid)}}">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button type="submit"
                                                                                class="btn danger p-x-md">بلی
                                                                        </button>
                                                                    </form>
                                                                </div>
                                                            </div>
