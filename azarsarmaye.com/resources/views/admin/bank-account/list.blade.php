                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <a data-toggle="modal" data-target="#new"
                           class="btn btn-sm text-sm text-sm-center btn-primary text-white pull-right">ثبت حساب
                            بانکی</a>
                        <div id="new" class="modal" data-backdrop="true">
                            <div class="row-col h-v">
                                <div class="row-cell v-m">
                                    <div class="modal-dialog modal-md">
                                        <form action="{{route('admin.bank-accounts.store')}}"
                                            ...
                                            <div class="modal-body text-center p-lg">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 form-group">
                                                        <label class="control-label text-right pull-left" for="iban">
                                                    ...
                                                    <div class="col-sm-4 form-group">
                                                        <label class="control-label text-right pull-left" for="card">شماره
                                                            کارت</label>
                                                        <input class="form-control" id="card" name="card" type="number"
                                                               placeholder="لطفا شماره کارت را وارد کنید">
                                                    </div>

                                                    <div class="col-sm-4 form-group">
                                                        <label class="control-label text-right pull-left" for="account">شماره
                                                            حساب</label>
                                                        <input class="form-control" id="account" name="account"
                                                               type="number" placeholder="لطفا شماره حساب را وارد کنید">
                                                    </div>
                                                    <div class="col-sm-4 form-group">
                                                        <label class="control-label text-right pull-left" for="photo">تصویر
                                                            کارت بانکی</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary pull-right p-x-md">ثبت حساب
                                                    بانکی
                                                </button>
                                            </div>
                                        </form>
                    ...
                    <div class="table-responsive">
                        @if(count($bank_accounts) === 0)
                            ...
                            <h5 class="text-center text-muted p-b-lg">اوپس، هنوز حساب بانکی ثبت نکردید، معطل چی
                                هستی؟</h5>
                        @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(auth()->user()->role === 6 && $item->status != 1)
                                                <a href="{{route('admin.mbank-accounts.accept',  $item->uuid)}}"
                                                        ...
                                                        <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{route('admin.bank-accounts.destroy', $item->uuid)}}"
                                                                        method="post">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button type="submit"
