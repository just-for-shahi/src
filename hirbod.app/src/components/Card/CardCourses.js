...
export default function CardCourses({ data, onClick, category }) {
        ...
        <div className="col-md-6 col-lg-4" onClick={() => onClick(data)}>
            <div className="single-blog-card card gray-light-bg border-0 shadow-sm my-3">
                ...
                <div className="card-body card-height">
                    ...
                    <p className="card-text mb-2 titles">{category}</p>
                    <h3 className="h5 mb-2 card-title card-title-height"><a >{data.title}</a></h3>
                    <div className="post-meta mb-2 ml-2">
                        ...
                        <div className="row meta-list">
                            <div className="col row mt-2">
                                ...
                                <div >
                                    <span>{data.students}</span>  دانش آموز
                                 </div>
                            </div>
