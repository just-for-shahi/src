...
import { fetchHome, fetchEvents } from "../../api";
import { EVENTS, EVENT_DETAIL } from "../../common/commonUrls";
...
export default function EventsPage({ crumbs }) {

    const { events, setEvents, page, setPage, } = useContext(CategoryContext);
    ...
    const handleClickDetail = (data) => {
        ...
        history.push(`${EVENTS}/${_.get(data, "uuid")}`)
    }
