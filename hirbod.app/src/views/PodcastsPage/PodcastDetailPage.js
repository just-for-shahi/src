...
import { fetchPodcastDetail, fetchCategories, fetchTags, fetchPodcasts } from "../../api";
import { StudentsIcon, ClockIcon } from "../../components/Icons";
import { CAT_PODCASTS } from "../../Enum";
import Comment from "../../components/Comment";
import Breadcrumbs from "../../components/BreadCrump";

export default function PodcastDetailPage({ crumbs }) {

    const { categories, setCategories, tags, setTags, podcasts, setPodcasts } = useContext(CategoryContext);
    ...
    const handleFetchData = async () => {
        setLoading(true);
        const res = await fetchPodcastDetail(Object.values(id));
    ...
    const handleFetchCategories = async () => {
        ...
        if (res) {
            const result = _.get(res, "data").filter(r => r.type === CAT_PODCASTS);
    ...
    useEffect(() => {
        ...
        if (podcasts.length < 1) handleFetchPodcasts();
                            ...
                            <div className="row">
                                <div className="col-lg-8 col-md-8">
                                    ...
                                    <article className="post">
                                        <div className="post-preview"><img src={_.get(data, "photo")} alt="پادکست" className="img-fluid image" /></div>
                                            ...
                                            <div className="post-header">
                                                ...
                                                <div className="row meta-list">
                                                    <div className="col row mt-2">
                                                        ...
                                                        <div >
                                                            <span>{_.get(data, "students")}</span>  دانش آموز
                                                    </div> */}
                                                    </div>
