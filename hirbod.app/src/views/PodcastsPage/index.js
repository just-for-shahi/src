...
import { fetchHome, fetchPodcasts } from "../../api";
import { PODCASTS, PODCAST_DETAIL } from "../../common/commonUrls";
import CardPodcasts from "../../components/Card/CardPodcasts";
import { PAGE_SIZE } from "../../Enum";
import Pagination from "../../components/Pagination";
import { paginate } from '../../utils/index';
import Breadcrumbs from "../../components/BreadCrump";

export default function PodcastsPage({ crumbs }) {
    const { podcasts, setPodcasts, page, setPage } = useContext(CategoryContext);
    ...
    useEffect(() => {
        ...
        handleFetchData();
        console.log('pod', podcasts)
    }, []);

    const handleClickDetail = (data) => {
        debugger
        history.push(`${PODCASTS}/${_.get(data, "uuid")}`)
    }
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-9 col-lg-7">
                                <div className="page-header-content text-white pt-4">
                                    <h1 className="text-white mb-0">پادکست ها</h1>
