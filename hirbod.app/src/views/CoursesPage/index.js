...
import { fetchHome, fetchCourses } from "../../api";
import { COURSES, COURSE_DETAIL } from "../../common/commonUrls";
...
export default function CoursesPage({ crumbs }) {

    const { courses, setCourses, page, setPage, } = useContext(CategoryContext);
    ...
    const handleClickDetail = (data) => {
        ...
        history.push(`${COURSES}/${_.get(data, "uuid")}`)
    }
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-9 col-lg-7">
                                <div className="page-header-content text-white pt-4">
                                    <h1 className="text-white mb-0">دوره های آموزشی</h1>
