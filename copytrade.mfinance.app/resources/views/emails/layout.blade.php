...
<body bgcolor="#ffffff">
<div align="center">
<table class="head-wrap w320 full-width-gmail-android" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#f9f8f8">
<tbody>
<tr>
<td width="100%" valign="top" height="8" bgcolor="#ffffff"><!-- [if gte mso 9]>
...
<div class="content"><span class="brand"> <a href="{{config('app.url')}}"> {{config('app.name')}} </a> </span></div>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td class="container">
<div class="content footer-lead"><a href="{{config('app.url')}}"><strong>Get in touch</strong></a> if you have any questions or feedback</div>
</td>
</tr>
</tbody>
</table>
