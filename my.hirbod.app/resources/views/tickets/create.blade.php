...
@section('pageTitle', 'ارسال تیکت پشتیبانی')
@section('content')
    <div class="padding">
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control" id="department" name="department">
                                            ...
                                            <option value="1">امورمالی</option>
                                            <option value="2">دوره‌های آموزشی</option>
                                            <option value="3">رویدادهای آموزشی</option>
                                            <option value="4">کتاب‌ها</option>
                                            <option value="5">پادکست‌ها</option>
                                            <option value="6">همکاری و بازاریابی</option>
                                            <option value="7">مدیران هیربد</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
