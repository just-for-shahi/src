        ...
        <div class="navbar" data-pjax>
            ...
            <div class="collapse navbar-toggleable-sm pull-right pull-none-xs" id="navbar">
                <ul class="nav navbar-nav text-info-hover" data-ui-nav>
                    ...
                    <li class="nav-item">
                        <a href="https://hirbod.ac" data-ui-scroll-to class="nav-link">
                            <span class="nav-text">وب‌سایت اصلی</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="footer black text-info-hover">
        <div class="container">
            <div class="p-y-lg b-b">
                <a href="https://hirbod.ac" class="btn info rounded pull-right pull-none-xs">دانلود اپلیکیشن</a>
                <div class="m-r">
                    <div class="text-md p-y-sm2">همین الان آموزش سالانه خود را تنها با صدهزارتومان شروع کنید</div>
                </div>
            </div>
        </div>
        <div class="p-y-lg">
