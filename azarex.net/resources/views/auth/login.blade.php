...
@section('page.description', 'ورود به پنل خرید و فروش ارزهای دیجیتال')
@section('styles')
            ...
            <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
                ...
                <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                    ...
                    <div class="login-form">
                        <!--begin::Form-->
                        <form class="form" id="kt_login_singin_form" action="{{route('auth.verify')}}" method="post">
                            @csrf
                            <!--begin::Title-->
                            <div class="pb-5 pb-lg-15">
                                ...
                                <div class="text-muted font-weight-bold font-size-h4">
                                    تازه وارد هستید؟
                                    <a href="{{route('auth.register')}}" class="text-primary font-weight-bolder">ثبت نام کنید!</a>
                                </div>
                            </div>
                            <!--begin::Title-->
                            ...
                            @if($errors->has('result'))
                                <div class="alert alert-danger">
                                    اوه نه، مشخصات ورود شما اشتباه است!
                                </div>
                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" name="email" placeholder="ایمیل خود را وارد کنید" autocomplete autofocus required/>
                            </div>
                            <!--end::Form group-->
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    ...
                                    <a href="#forgot" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">
                                        رمز عبور خود را فراموش کردید؟
                                    </a>
                                </div>
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="password" name="password" placeholder="رمزعبور خود را وارد کنید" autocomplete="off"/>
                            </div>
                            <!--end::Form group-->
