            ...
            <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">حساب‌های بانکی</h5>
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{route('panel.bankAccounts.index')}}" class="text-muted">حساب‌های بانکی</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero"></path>
                    ...
                    <div class="alert-text">برای ثبت حساب بانکی و استفاده از خدمات صرافی آذر با بانک‌ها بایستی حساب
...
</svg><!--end::Svg Icon--></span> ثبت حساب بانکی
                            </button>
                            <!--end::دکمه-->
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">ثبت حساب بانکی</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="بستن">
                                                <i aria-hidden="true" class="ki ki-close"></i>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="{{route('panel.bankAccounts.store')}}" method="post">
                                                @csrf
                                                <div>
                                                    <div>

                                                        <div class="form-group">
                                                            <label class="font-size-h6 font-weight-bolder text-dark" for="account">شماره حساب</label>
                                                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="number" name="account" placeholder="شماره حساب بانکی خود را بنویسید" autocomplete autofocus required/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="font-size-h6 font-weight-bolder text-dark" for="card">شماره کارت</label>
                                                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="number" name="card" placeholder="شماره کارت بانکی خود را بنویسید" autocomplete required/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="font-size-h6 font-weight-bolder text-dark" for="iban">شماره شبا</label>
                                                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="number" name="iban" placeholder="شماره شبا خود را بدون IR بنویسید" autocomplete required/>
                                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1">بانک عامل</th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1">IBAN</th>
