...
@section('page.title', 'کد یکبار مصرف')
@section('wrapper')
    <main class="main">
                ...
                <div class="row margin-bottom">
                    <div class="col-lg-6">
                        <div class="heading heading--primary"><span class="heading__pre-title">خوشحال دوباره کنارهم هستیم.</span>
                            <h2 class="heading__title"><span>کد</span> <span>یکبار مصرف</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        @if($errors->has('error'))
                            <div class="alert alert-danger">
                                اوپس، مشکلی در اعتبارسنجی اطلاعات ارسالی شما وجود دارد!
                            </div>
                            <br/>
                        @endif
                        <form class="form user-form" method="post" action="{{route('verified')}}">
                            @csrf
                            <input type="hidden" name="mobile" value="{{$mobile}}">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input class="form__field" type="number" name="code" value="{{old('code')}}" placeholder="کد تاییدیه یکبار مصرف مانند 1376712"/>
                                    <button class="form__submit" type="submit">احراز هویت	</button>
                                </div>
                                <div class="col-lg-6">
                                    <ul>
