            ...
            <div class="col-lg-12 col-md-12">
                <div class="dashboard-list-box margin-top-0">
                    <div class="booking-requests-filter">
                        <a href="{{route('projects.create')}}" class="button"><i class="sl sl-icon-plus"></i>ارسال پروژه</a>
                    </div>
                        ...
                        @foreach($items as $item)
                                <li class="pending-booking">
                                    ...
                                    <div class="buttons-to-right">
                                        <a href="{{route('projects.show', ['uuid' => $item->uuid])}}" class="button gray approve"><i class="sl sl-icon-pencil"></i> ویرایش</a>
                                        <a href="{{route('projects.destroy', ['uuid' => $item->uuid])}}" class="button gray reject"><i class="sl sl-icon-close"></i> حذف</a>
                                    </div>
                                </li>
                        @endforeach
                    </ul>
